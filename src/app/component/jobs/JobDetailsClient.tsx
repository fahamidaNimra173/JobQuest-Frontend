...
export default function JobDetailsClient({ jobId, primaryEnquiries }: JobDetailsClientProps) {
    ...
    const applyMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            setIsApplied(true);
            setEnquiryAnswers(primaryEnquiries ? new Array(primaryEnquiries.length).fill('') : []);
    ...
    const saveJobMutation = useMutation({
        mutationFn: async () => {
            const response = await axiosInstance.patch('/candidates/save-job', {
                jobId: jobId,
            });
            return response.data;
        },
    ...
    return (
        <>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
                ...
                >
                    {applyMutation.isPending ? 'Applying...' : isApplied ? 'Already Applied' : 'Apply Now'}
                </button>
                <button
            ...
            {/* <button
                ...
                title={isSaved ? 'Job already saved' : 'Save this job'}
            >
                {isSaved ? (
                    <BookmarkCheck size={20} className="text-[#7670d6]" />
                ) : (
            ...
            {showApplyForm && primaryEnquiries && primaryEnquiries.length > 0 && (
                <div className="bg-white rounded-xl shadow-md p-6 mt-6">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                        Please answer all questions to complete your application. Your responses will be reviewed by the employer.
                    </p>

        ...
        <div className="relative z-10 flex min-h-screen">
          ...
          <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12 relative">
            ...
            >
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 shadow-2xl max-w-xs">
                <div className="text-white/90 text-sm italic leading-relaxed">
                  Building your profile is building your future. Start crafting
                  the career story you want to tell.
                </div>
                <div className="text-white/70 text-xs mt-3 font-medium">
            ...
            >
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 shadow-2xl max-w-xs">
                <div className="text-white/90 text-sm italic leading-relaxed">
                  Join thousands of candidates who found their dream roles. Your
                  next opportunity awaits you here.
                </div>
                <div className="text-white/70 text-xs mt-3 font-medium">
                  — Community Success
                </div>
            ...
            >
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 shadow-2xl max-w-xs">
                <div className="text-white/90 text-sm italic leading-relaxed">
                  Your talent deserves recognition. Register now and connect
                  with employers looking for someone like you.
                </div>
                <div className="text-white/70 text-xs mt-3 font-medium">
                  — Opportunity Awaits
                </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          required
                          className={`w-full px-4 py-3 border rounded-xl bg-white/70 backdrop-blur-sm text-[#7670d6] placeholder:text-[#7670d6] focus:outline-none focus:bg-white/75 transition-all duration-300 font-medium ${
                            isPasswordValid

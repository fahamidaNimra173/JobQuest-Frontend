  ...
  return (
    <div className="space-y-6">
      ...
      <div
        ...
        style={{ background: "linear-gradient(to right, #7670d6, #9da0dc)" }}
      >
        ...
        {statCards.map((stat, index) => (
          <div key={index} className={`rounded-lg p-6 ${stat.bgColor}`}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-300 dark:text-white text-sm font-medium">
                  {stat.title}
                </p>
          ...
          <div className="space-y-3">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div
                ...
                style={{ width: "85%", backgroundColor: "#7670d6" }}
              ></div>
            </div>
          ...
          <div className="space-y-3">
            <div className="text-sm">
              ...
              <p className="text-xs text-gray-500 flex items-center">
                ...
                Remote • <DollarSign className="w-3 h-3 ml-2 mr-1" />
                $80k-100k
              </p>
            </div>
            <div className="text-sm">
              ...
              <p className="text-xs text-gray-500 flex items-center">
                <MapPin className="w-3 h-3 mr-1" />
                New York • <DollarSign className="w-3 h-3 ml-2 mr-1" />
                $90k-120k
              </p>
            </div>
          </div>
